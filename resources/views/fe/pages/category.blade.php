                ...
                ?>
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="rent-item mb-4">
                            <img class="img-fluid mb-4" src="{{asset('public/be/images')}}/products/imagesPro/{{$item->image}}">
                            ...
                            <a class="btn btn-primary px-3" href="{{route('fe.detail',[khongdau($item->id),$item->id] )}}">View Detail</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
