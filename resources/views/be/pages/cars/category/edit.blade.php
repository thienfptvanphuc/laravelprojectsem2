    ...
    <div class="row " >
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form action="{{route('be.categoryedit', $load->id)}}" method="post" enctype="multipart/form-data" id="editCategoryForm" >
                    @csrf
                    <div class="card-body ">
                        ...
                        <div class="form-group col-md-10">
                            <label>Type Id</label>
                            <input type="text" name="id_type" class="form-control" value="{{old('id_type',isset($load)?$load->id_type:null)}}"
                        ...
                        <div class="form-group mb-0 col-md-10">
                            ...
                            <input type="radio" name="type_status" value=1 <?php if(($load->type_status)==1) echo "checked";?>> Active
                            <input type="radio" name="type_status" value=0 <?php if(($load->type_status)==0) echo "checked"; ?>> Hide
                        </div>
                    </div>
                    <div class="card-footer">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="resetForm()"><i class="fa fa-undo"></i>
                            Reset</button>
                        <a href="{{route('be.category')}}" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Back</a>
                    </div>
                </form>
                <!-- form end -->
            </div>
